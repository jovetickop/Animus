...
jovetickop 的 Claude Code 个人工具包。包含 **24 个技能**（20 个 superpowers-zh 中文技能 + harness-cc 编码工作流引擎 + tdd-workflow + planning-with-files 计划管理 + integrate-to-animus 集成工具）以及配置模板。

## 架构

animus-toolkit 将个人开发工具打包为标准 Claude Code 插件：

- **skills/** — 24 个技能，覆盖从需求探索到代码交付的完整开发生命周期
- **hooks/** — 状态栏钩子脚本
...
| 类别 | 内容 | 参考文档 |
|------|------|---------|
| 技能列表 | 24 个技能说明、触发方式、路径 | [技能参考](./docs/skills-reference.md) |
| 开发工作流 | 技能如何协作、完整流程说明 | [工作流指南](./docs/workflow-guide.md) |
| 状态栏 | session/模型/目录/上下文余量显示 | [状态栏配置](./docs/statusline-setup.md) |
